...
namespace Lab02.Controllers
{
    public class TheloaitinController : Controller
    {
        ...
        //Hàm Datails truyền dữ liệu sang trang Details.aspx
        //Với tham số được truyền là IDLoai (trong bảng Theloaitin)
        public ActionResult Details(int id)
        {
            var Details_tin = data.Theloaitins.Where(mbox => m.IDLoai == id).First();
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
            ...
            {
            ViewData["Loi"] = "Thể laoại tin không được để trống ";
            }
